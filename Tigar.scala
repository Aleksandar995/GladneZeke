...
object Tigar extends Thread {
	...
	var x1 = 300;
	var y1 = 0;
	var slikaL = new Image(new File("tigarL.png").toURI().toString());
	var slikaD = new Image(new File("tigarD.png").toURI().toString());
	var slikaN = new Image(new File("tigarN.png").toURI().toString());
