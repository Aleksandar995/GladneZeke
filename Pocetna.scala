...
object Pocetna extends JFXApp {
	...
	var bodovi2 = 0;
	//deklarisanje zvuka
	var media = new Media(new File("uvodna.mp3").toURI().toString());
	var mediaPlayer = new MediaPlayer(media);
	var izgubio = new Media(new File("izgubio.mp3").toURI().toString());
	var izgubioMP = new MediaPlayer(izgubio);
	var zavrseno = new Media(new File("izgubio (2).mp3").toURI().toString());
	var zavrsenoMP = new MediaPlayer(zavrseno);
	var eatZ = new Media(new File("eat.mp3").toURI().toString());
	...
	var stejdz  = new PrimaryStage{
		...
		pocetak = new Scene(824,543) {
			...
			gc.drawImage(new Image(new File("suma.jpg").toURI().toString()), 0, 0);

			//sunce
			gc.drawImage(new Image(new File("sunce6.png").toURI().toString()), 30, 20);

			// zeka
			gc.drawImage(new Image(new File("zeka1.png").toURI().toString()), 250, 310);

			// sargarepa
			gc.drawImage(new Image(new File("sargarepa1.png").toURI().toString()), 520, 80);

			// kupus
			gc.drawImage(new Image(new File("kupus1.png").toURI().toString()), 520, 200);
			...
			gc.drawImage(new Image(new File("rsz_up.png").toURI().toString()), 360, 285);
			...
			var zvuk = new Button ()
					...
					zvuk.prefHeight = 30
					zvuk.prefWidth = 30
					zvuk.style = """-fx-background-image: url('on.png'); 
			...
			gcZeke12.drawImage(new Image(new File("zekaMali.png").toURI().toString()), 10, 0);
			gcZeke12.drawImage(new Image(new File("zec2l.png").toURI().toString()), 10, 50);
			...
			zvuk.onAction = (e: ActionEvent) => {
				if(ukljucenZvuk){
					mediaPlayer.pause();
					zvuk.style = """-fx-background-image: url('off.png'); -fx-background-radius: 30; -fx-background-position : center; """;
					ukljucenZvuk = false;
				} 
				else{
					mediaPlayer.play();
					zvuk.style = """-fx-background-image: url('on.png'); -fx-background-radius: 30; -fx-background-position : center; """;
					ukljucenZvuk = true;
				}
			};
			...
			var scenaS = new Scene(700, 500){
				...
				timerS = AnimationTimer(t=>{
					...
					gc.drawImage(new Image(new File("trava.jpg").toURI().toString()), 0, 0);
			...
			var krajS = new Scene (700, 500){
				...
				gcKS.drawImage(new Image(new File("trava.jpg").toURI().toString()), 0, 0);
