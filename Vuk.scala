...
object Vuk extends Thread{
	...
	var y2 = 0;
	var slikaDD = new Image(new File("pasDD.png").toURI().toString());
	var slikaLD = new Image(new File("pasLD.png").toURI().toString());
	var slikaLG = new Image(new File("pasLG.png").toURI().toString());
	var slikaDG = new Image(new File("pasDG.png").toURI().toString());
	var slika1=slikaLG;
	var slika2=slikaLD;
	var ind = true;
	var ind2 = true;
